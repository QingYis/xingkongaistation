...
func InitOptionMap() {
	...
	common.OptionMap["ChannelSmartRoutingEnabled"] = strconv.FormatBool(common.ChannelSmartRoutingEnabled)
...
func updateOptionMap(key string, value string) (err error) {
	...
	if strings.HasSuffix(key, "Enabled") || key == "DefaultCollapseSidebar" || key == "DefaultUseAutoGroup" || key == "SMTPForceAuthLogin" {
		...
		case "ChannelSmartRoutingEnabled":
			common.ChannelSmartRoutingEnabled = boolValue
